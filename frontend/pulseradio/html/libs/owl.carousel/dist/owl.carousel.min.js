...
!function (a, b, c, d) {
  ...
  e.Defaults = {
    ...
    b.each(a.proxy(function (b, c) {
      ...
      }, this)).attr("src", c.attr("src") || c.attr("data-src-mp3") || c.attr("data-src-mp3-retina"))
    }, this))
  ...
  e.Defaults = {lazyLoad: !1}, e.prototype.load = function (c) {
    ...
    !e || a.inArray(d.get(0), this._loaded) > -1 || (e.each(a.proxy(function (c, d) {
      var e, f = a(d), g = b.devicePixelRatio > 1 && f.attr("data-src-mp3-retina") || f.attr("data-src-mp3");
  ...
  e.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, e.prototype.fetch = function (a, b) {
    ...
    return b.wrap('<div class="owl-video-wrapper"' + g + "></div>"), this._core.settings.lazyLoad && (i = "data-src-mp3", j = "owl-lazy"), h.length ? (l(h.attr(i)), h.remove(), !1) : void ("youtube" === c.type ? (f = "//img.youtube.com/vi/" + c.id + "/hqdefault.jpg", l(f)) : "vimeo" === c.type ? a.ajax({
      type: "GET",
