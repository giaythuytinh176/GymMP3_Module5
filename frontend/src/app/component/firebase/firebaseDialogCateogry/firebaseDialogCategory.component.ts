...
@Component({
  selector: 'app-firebase-category-dialog',
  templateUrl: 'firebaseDialogCategory.component.html',
  styleUrls: ['firebaseDialogCategory.component.scss']
})
export class FirebaseDialogCategoryComponent implements OnInit {
  title = 'cloudsSorage';
